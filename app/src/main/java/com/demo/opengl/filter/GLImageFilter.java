...
public class GLImageFilter {
    ...
    public void initProgramHandle() {
        ...
        if (!TextUtils.isEmpty(mVertexShader) && !TextUtils.isEmpty(mFragmentShader)) {
            ...
            mIsInitialized = true;
            Log.d("initProgramHandle",getClass().getSimpleName());
        } else {
            ...
            Log.d("initnot",getClass().getSimpleName());
    ...
    public int drawFrameBuffer(int textureId, FloatBuffer vertexBuffer, FloatBuffer textureBuffer) {
        ...
        if (textureId == OpenGLUtils.GL_NOT_TEXTURE || mFrameBuffers == null
            ...
            Log.d("GLImageFilter","drawFrameBuffer");
            return textureId;
        }
    ...
    public void initFrameBuffer(int width, int height) {
        if (!isInitialized()) {
            Log.d("!isInitialized()",getClass().getSimpleName());
            return;
        }
