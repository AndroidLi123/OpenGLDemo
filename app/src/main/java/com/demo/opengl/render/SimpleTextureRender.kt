 ...
 * @version: 1.0.0
 */
class SimpleTextureRender : GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(gl: GL10, config: EGLConfig) {
        ...
        GLES30.glShaderSource(
            vertexShader,
            Util.loadShaderFromAssets("texture.vs")
        )
        GLES30.glShaderSource(
            fragmentShader,
            Util.loadShaderFromAssets("texture.fs")
        )
        ...
        GLES30.glVertexAttribPointer(
            LOCATION_ATTRIBUTE_TEXTURE_COORDINATE,
            TEXTURE_COORDINATE_COMPONENT_COUNT, GLES30.GL_FLOAT, false, 0,
            textureCoordinateDataBuffer
        )
        ...
        val bitmap = Util.decodeBitmapFromAssets("board_texture.png")
